...
<div class="modal fade" id="declineModal" tabindex="-1" aria-labelledby="declineModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="declineModalLabel">Batalkan Permintaan</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
            ...
            <div class="modal-footer">
                <form action="<?=BASEURL?>dashboard/requestHandler" method="POST" id="declineForm">
                    ...
                    <button type="sumbit" class="btn btn-warning" data-bs-dismiss="modal">Batal</button>
                </form>
            </div>
        </div>
    </div>
                            ...
                            <tbody>
                                ...
                                <tr class="<?php if($data['payment_type'] == 0){ echo 'table-info'; } ?>">
                                    ...
                                    <td class="text-center">
                                        ...
                                        <a href="<?=BASEURL?>dashboard/overview/<?=$data['slug']?>" class="btn btn-sm btn-primary">Lanjutkan</a>
                                        <?php endif?>
                                        <button class="btn btn-sm btn-danger" onclick="confirmDecline(<?=$data['id']?>)">Batal</button>
                                    </td>
                                    </td>
                                </tr>
                                <?php endforeach?>
